...
namespace TPulseAPI
{
	public class ConfigFile
	{
		...
		[Description(
			"Backup frequency in minutes. So, a value of 60 = 60 minutes. Backups are stored in the \\tpulse\\backups folder.")] public int BackupInterval;
        ...
        [Description("Deprecated. Use ServerName instead.")] public string ServerNickname = "TPulse Server";
		...
		[Description(
			"Some tiles are 'fixed' by not letting TPulse handle them. Disabling this may break certain aesthetic tiles.")] public
